...
def process_files(directory):
    ...
    for fp in files:
        ...
        try:
            ...
            # Remove entire top-bar
            content = re.sub(r'<div class="top-bar">.*?</div>\s*<!-- Header Section -->', r'<!-- Header Section -->', content, flags=re.IGNORECASE|re.DOTALL)
            ...
            # For pages where top-bar isn't neatly before <!-- Header Section -->
            content = re.sub(r'<div class="top-bar">.*?</div>', '', content, flags=re.IGNORECASE|re.DOTALL)
